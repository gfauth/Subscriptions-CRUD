...
namespace ObserverApi.Services.Product
{
    public class CreateServiceTests
    {
        ...
        public async void Deve_criar_nova_produto_com_sucesso()
        {
            ...
            productRepositoryMock.Setup(x => x.InsertProduct(It.IsAny<Products>()))
                .ReturnsAsync(FakeData.SuccessCreateProductServiceResponse(requestData));
        ...
        public async void Deve_tentar_criar_nova_produto_e_retornar_erro_CreateProductError()
        {
            ...
            productRepositoryMock.Setup(x => x.InsertProduct(It.IsAny<Products>()))
                .ReturnsAsync(FakeData.NoDataFoundCreateProductServiceResponse());
